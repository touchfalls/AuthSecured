...
public class DependencyContainer {
    ...
    private UnifiedCommandExecutor commandExecutor;
    private PlayerRestrictionManager restrictionManager;

    public DependencyContainer(AuthPlatform platform) {
        this.platform = platform;
    }

    public void init() {
        File dataFolder = platform.getDataFolder();
        PlatformLogger logger = platform.getLogger();
        ...
        this.commandExecutor = new UnifiedCommandServiceImpl(authService, platform, configManager.getLocalizationManager(), ipHashService);
    ...
    public UnifiedCommandExecutor getCommandExecutor() { return commandExecutor; }
